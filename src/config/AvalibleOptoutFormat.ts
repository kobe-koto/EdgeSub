...
export type EndpointExtendConfigPrototype = ("RuleProvider" | "RuleProvidersProxy" | "BaseConfigUserspec" | "isUDP" | "isSSUoT" | "RuleProviderUserspec" | "ForcedWS0RTT")
...
const AvalibleEndpoints: EndpointPrototype[] = [
    {
        key: "Sing Box",
        value: "/sub/sing-box",
        ExtendConfig: ["RuleProvider", "RuleProviderUserspec", "RuleProvidersProxy", "BaseConfigUserspec", "isUDP", "isSSUoT", "ForcedWS0RTT"]
    },
    {
        key: "Clash Meta",
